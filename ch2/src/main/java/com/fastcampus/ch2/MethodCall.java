...
public class MethodCall {
	...
	static void render (HashMap map, String viewName) throws FileNotFoundException {
		...
		while(sc.hasNextLine()) {
			result += sc.nextLine() + System.lineSeparator();	// 줄구분 (개행 단위로 구분)
		}
		
		System.out.println("render result :"+result);
		
		// 2. map에 담긴 key를 하나씩 읽어서 template의 ${key}를 value 바꾼다.
 ...
 * 
 * 
 * [실행결과] before:{} after :{id=asdf, pwd=1111} [txtView2.txt] id:asdf pwd:1111
 */